...
func makeBasicControlsPage() ui.Control {
	...
	lbl	:=ui.NewLabel("host ip:port")
	btn := ui.NewButton("Connect")

	hostIP:= ui.NewEntry()
	hostIP.SetText( ":50000")

	hbox.Append(lbl, false)
	hbox.Append(hostIP, false)
...
func setupUI() {
	mainwin = ui.NewWindow("DC Motor client", 640, 480, true)
